...
*Very interestingly, correlation strength for the early week 15x15 days (Mon=.54, Tue=.51, Wed=.45) was higher than those for the later week days (Thu=.36, Fri=.41, Sat=.38). This attests to the relative heterogeneity of later week puzzles, and the likely fact that the likelihood of a solver getting stuck in one particular spot for an extended peroof time goes way up. I have zero evidence for this, but I will further speculate as an experienced solver that Thu puzzles have the lowest correlation of all because they are the most heterogeneous of all puzzle days due to the varied gimmicks and tricks employed.*
